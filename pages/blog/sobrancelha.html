...
<head>
    ...
    <link rel="stylesheet" href="sobrancelha.css">
                ...
                <section id="posts" class="content-area">
                    <article class="content">
                        ...
                        <header class="posts-header">
                            <h4>
                                <a href="sobrancelha.html">Design</a>
                            </h4>
                    ...
                    <article class="content">
                        ...
                        <header class="posts-header">
                            <h4 class="posts-tittle">
                                <a href="sobrancelha.html">Design + Henna</a>
                            </h4>
                            <div class="posts-content">
                                <p>Conteúdos a cerca de sobrancelha.</p>
                                <a href="sobrancelha.html" class="more-link">Leia mais</a>
                    ...
                    <article class="content">
                        ...
                        <header class="posts-header">
                            <h4 class="posts-tittle">
                                <a href="sobrancelha.html">Brow Lamination</a>
                            </h4>
                            <div class="posts-content">
                                <p>Conteúdos a cerca de sobrancelha.</p>
                                <a href="sobrancelha.html" class="more-link">Leia mais</a>
