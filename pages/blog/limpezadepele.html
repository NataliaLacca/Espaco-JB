...
<head>
    ...
    <link rel="stylesheet" href="limpezadepele.css">
                ...
                <section id="posts" class="content-area">
                    <article class="content">
                        ...
                        <header class="posts-header">
                            <h4>
                                <a href="limpezadepele.html">Como funciona?</a>
                            </h4>
                    ...
                    <article class="content">
                        ...
                        <header class="posts-header">
                            <h4 class="posts-tittle">
                                <a href="limpezadepele.html">Cuidados</a>
                            </h4>
                            <div class="posts-content">
                                <p>Conteúdos a cerca de limpeza de pele.</p>
                                <a href="limpezadepele.html" class="more-link">Leia mais</a>
                    ...
                    <article class="content">
                        ...
                        <header class="posts-header">
                            <h4 class="posts-tittle">
                                <a href="limpezadepele.html">Acne</a>
                            </h4>
                            <div class="posts-content">
                                <p>Conteúdos a cerca de limpeza de pele.</p>
                                <a href="limpezadepele.html" class="more-link">Leia mais</a>
