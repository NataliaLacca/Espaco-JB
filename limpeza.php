...
<head>
    ...
    <title>Espaço JB - Blog - Limpeza de pele</title>
</head>
    ...
    <section id="posts" class="content-area">
        <article class="content">
            ...
            <header class="posts-header">
                <h4>
                    <a href="limpeza.php">Como funciona?</a>
                </h4>
                <div class="posts-content">
                    <p>Conteúdos a cerca de limpeza de pele.</p>
                    <a href="limpeza.php" class="more-link">Ler mais ></a>
                </div>
            </header>
        </article>
        <br>
