...
<head>
    ...
    <title>Espaço JB - Blog - Sobrancelha</title>
</head>
    ...
    <section id="posts" class="content-area">
        <article class="content">
            ...
            <header class="posts-header">
                <h4>
                    <a href="sobrancelha.php">Design</a>
                </h4>
                <div class="posts-content">
                    <p>Conteúdos a cerca de sobrancelha.</p>
                    <a href="sobrancelha.php" class="more-link">Ler mais ></a>
                </div>
            </header>
        </article>
        <br>
        ...
        <article class="content">
            ...
            <header class="posts-header">
                <h4 class="posts-tittle">
                    <a href="sobrancelha.php">Design + Henna</a>
                </h4>
                <div class="posts-content">
                    <p>Conteúdos a cerca de sobrancelha.</p>
                    <a href="sobrancelha.php" class="more-link">Ler mais ></a>
        ...
        <article class="content">
            ...
            <header class="posts-header">
                <h4 class="posts-tittle">
                    <a href="sobrancelha.php">Brow Lamination</a>
                </h4>
                <div class="posts-content">
                    <p>Conteúdos a cerca de sobrancelha.</p>
                    <a href="sobrancelha.php" class="more-link">Ler mais ></a>
